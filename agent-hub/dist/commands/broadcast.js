...
export async function runBroadcast(promptArg, options = {}) {
    loadEnvAndConfig();
    ...
    console.log(boxen(`${chalk.bold.hex('#F59E0B')('📡 Agent Hub Broadcast & Consensus 📡')}\n` +
    ...
    for (const r of results) {
        ...
        console.log(boxen(`${statusHeader}\n\n${r.output.trim()}`, {
            padding: 1,
            margin: { top: 1, bottom: 1 },
            borderColor: r.success ? r.color || 'cyan' : 'yellow',
            borderStyle: 'single'
        }));
    }
}
