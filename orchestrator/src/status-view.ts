...
export function renderStatus(state: RunStateDoc, health: ModelHealth[], extra: { taskLabel: string; elapsedMs: number; testsSummary: string; reviewer: string; lastAction: string }): string {
